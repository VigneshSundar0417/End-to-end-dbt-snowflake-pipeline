...
# ----------------------------
sf_user = "vi"
sf_password = "Vig"        # <-- your Snowflake password
sf_account = "SGIVF"               # <-- Snowflake account identifier only
sf_warehouse = "MY_WH"
...
# Convert Date column to Python datetime (compatible with Snowflake)
...
# ----------------------------
# Step 3: Set warehouse, database, and schema explicitly
# ----------------------------
